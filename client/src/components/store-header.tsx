...
          
          {/* 1. AGRUPAMENTO: LOGO + NOME DA LOJA (GRANDE) */}
...
            />
            {/* Nome Grande: Visível apenas em telas médias (md) e maiores */}
            <h1 className="hidden md:block text-5xl lg:text-6xl font-extrabold text-white">
                Horizonte Açaí
            </h1>
          </div>
          {/* FIM DO AGRUPAMENTO LOGO + NOME */}
          
          {/* 2. GRUPO: BARRA DE BUSCA + BOTÕES ADMIN/CARRINHO */}
          <div className="flex items-center gap-2"> 
            
            {/* DIV DA BARRA DE BUSCA E STATUS */}
